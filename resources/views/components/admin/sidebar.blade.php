<nav class="sidebar">
    <div class="logo d-flex justify-content-between">
        <a class="large_logo" href="index.html"><img src="{{ asset('assets-admin/img/logo.png') }}" alt></a>
        <a class="small_logo" href="index.html"><img src="{{ asset('assets-admin/img/mini_logo.png') }}" alt></a>
    ...
    <ul id="sidebar_menu">
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('assets-admin/img/menu-icon/21.svg') }}" alt>
                </div>
                <div class="nav_title">
                    <span>Widgets</span>
                </div>
