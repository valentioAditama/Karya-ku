...
<!-- delete data -->
@foreach($getCommentCommunity as $data)
<div class="modal fade modal-primary" id="modal-delete-status-comment-community{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header justify-content-center">
        <div class="modal-profile">
      ...
      <form action="{{ route('admin.community-comments.delete', $data->id) }}" method="post">
        @csrf
        @method('delete')
        <div class="modal-body">
