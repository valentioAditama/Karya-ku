...
@section('content')
<!-- Banner-category -->
<section class="banner-category-fotografi">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12">
                        <div class="banner-category-title text-light">
                            <p class="h2">Fotografi</p>
                            <p class="banner-category-sub-title">
                                Kategori ini akan mencakup berbagai jenis fotografi, seperti potret, lanskap, arsitektur, <br> mode, makanan, dan sebagainya
                        </div>
                    </div>
                </div>
            </div>
