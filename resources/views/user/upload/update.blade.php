...
<section>
    ...
    <div class="container">
        <form action="{{route('upload.update', $getDataContent->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row mt-5 mb-5">
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="">Judul</label>
                        <input type="text" class="form-control" name="title" maxlength="40" value="{{ $getDataContent->title }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="">Sub Judul</label>
                        <input type="text" class="form-control" name="sub_title" maxlength="150" value="{{ $getDataContent->sub_title }}" required>
                    </div>
                    <div class="mb-3">
                ...
                <div class=" col-md-6">
                    ...
                    <textarea class="form-control" name="description" id="" cols="30" rows="13" required>{{ $getDataContent->description }}</textarea>
